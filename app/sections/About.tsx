...
export default function About() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl rounded-[1.75rem] border border-cyan-400/20 bg-[linear-gradient(90deg,rgba(34,211,238,0.18),rgba(255,255,255,0.05),rgba(34,211,238,0.18))] p-px sm:rounded-[2.5rem]">
        <div className="grid min-w-0 items-center gap-10 rounded-[1.75rem] bg-[#050816]/90 p-4 backdrop-blur-md sm:rounded-[2.5rem] sm:p-6 lg:grid-cols-[0.9fr_1.1fr] lg:p-12 xl:gap-20">
          <div className="relative mx-auto aspect-square w-full max-w-64 overflow-hidden rounded-full border border-cyan-400/20 bg-slate-900/50 shadow-2xl shadow-cyan-500/10 sm:max-w-95 lg:ml-12 lg:max-w-105">
            <Image
              src={PraisePhoto}
              alt="Praise Innocent"
              fill
